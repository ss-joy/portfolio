  ...
  return (
    <Element name="Experience">
      <section className="w-full min-h-screen pt-12">
        ...
        {/* card  */}
        <div className="p-7 mt-8 flex items-start gap-4 bg-sky-200/40 rounded-lg overflow-hidden">
          <Image
            src={airly}
            width={100}
            height={100}
          ...
          <div className="px-2 flex flex-col gap-2">
            <Link
              ...
              target="_blank"
              className="text-3xl bg-gradient-to-r from-sky-900 via bg-sky-500 to-sky-600 bg-clip-text text-transparent"
            >
              Airly Studio
            </Link>
