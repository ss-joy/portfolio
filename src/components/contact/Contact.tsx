...
const contactInfos: ContactInfo[] = [
  {
    iconUrl: <FaFacebook className="block w-full h-full text-sky-600" />,
    idLink: "https://www.facebook.com/profile.php?id=100080048493810",
    type: "link",
  },
  {
    iconUrl: <FaGithub className="block w-full h-full text-sky-600" />,
    idLink: "https://github.com/ss-joy",
    type: "link",
  },
  {
    iconUrl: <FaInstagram className="block w-full h-full text-sky-600" />,
    idLink: "https://www.instagram.com/sakil_s_joy/",
    type: "link",
  },
  {
    iconUrl: <FaLinkedin className="block w-full h-full text-sky-600" />,
    idLink: "https://www.linkedin.com/in/sakil-sazzad-joy-56a716274/",
    type: "link",
  },
  {
    iconUrl: <BiLogoGmail className="block w-full h-full text-sky-600" />,
  ...
  return (
    <Element name="Contact">
      <section className="w-full min-h-fit pt-12 relative">
        <SectionHeader headingText="Contact Me">
          <Satellite className="text-sky-300 absolute size-16 -top-16 lg:-top-20 right-2 lg:-left-16 -rotate-45 border-2 border-sky-300 rounded-full p-2 animate-pulse" />
        </SectionHeader>
        ...
        <svg
          ...
          className="w-full max-h-[100px] md:max-h-[300px] text-sky"
        >
          <motion.path
            initial={{
              pathLength: 0,
        ...
        <section className="text-center text-sky-400 relative">
