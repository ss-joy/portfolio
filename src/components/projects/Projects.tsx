...
const projects: Project[] = [
  ...
  //       </ProjectDescriptionHeader>
  //       <ul>
  //         <PointedListItem>Wrote backend logic to store and serve user statistics to the main site.</PointedListItem>
  //         <PointedListItem>Wrote fairly complex SQL for storing and serving career post info.</PointedListItem>
  //       </ul>
  //     </>
  //   ),
  // },
